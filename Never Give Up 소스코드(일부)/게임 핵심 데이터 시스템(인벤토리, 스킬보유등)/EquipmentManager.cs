...
//스킬, 장비장착정보, 인벤토리등 데이터를 관리하는 각 클래스
//(SkillManager, EquipmentManager, ItemManager등)는
//데이터 변경 시 이벤트를 발생시키고, 이를 구독한 UI 컨트롤러가 이벤트 발생 시
//해당 메소드를 호출해 UI를 갱신하도록 코드를 작성했습니다.
