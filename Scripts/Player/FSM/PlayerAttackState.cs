...
//플레이어 일반 공격상태 클래스입니다.
public class PlayerAttackState : FSMSingleton<PlayerAttackState>, IFSMState<PlayerController>
{
    ...
    public void Execute(PlayerController e)
    {
        ...
        {
            if (e.SkillController.IsComboEnableTime)
            {
                e.SkillController.IsCombo = true;
            }
        }
    }
